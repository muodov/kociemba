...
def load_cachetable(name):
    ...
    try:
        ...
        print 'could not read cache for %s' % name, e
    return obj
...
class CoordCube(object):
    ...
    # flip = 0 in phase 2.
    print 'Move table for the flips of the edges'
    ...
    print 'Move table for permutation of six corners. The positions of the DBL and DRB corners are determined by the parity.'
    ...
    print 'Move table for the permutation of six U-face and D-face edges in phase2. The positions of the DL and DB edges are'
    ...
    print 'Move table for the three edges UR,UF and UL in phase1.'
    ...
    print 'Move table for the three edges UB,DR and DF in phase1.'
    ...
    print 'Table to merge the coordinates of the UR,UF,UL and UB,DR,DF edges at the beginning of phase2'
    ...
    print 'Pruning table for the permutation of the corners and the UD-slice edges in phase2.'
    ...
    # The pruning table entries give a lower estimation for the number of moves to reach the solved cube.
    print 'Pruning table for the permutation of the edges in phase2.'
    ...
    print 'Pruning table for the twist of the corners and the position (not permutation) of the UD-slice edges in phase1'
    ...
    # The pruning table entries give a lower estimation for the number of moves to reach the H-subgroup.
    print 'Pruning table for the flip of the edges and the position (not permutation) of the UD-slice edges in phase1'
